...
const listS3 = path =>
  s3.listObjectsV2({ Prefix: path, Bucket: s3Bucket }).promise().then(files =>
    files.Contents.sort((b, a) => a.LastModified - b.LastModified).map(file =>
      Object.assign(file, {
